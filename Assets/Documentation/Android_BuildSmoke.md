...
4. **Build** APK to e.g. `Build_Apk/MergeDefense_M1_Day4.apk`
5. Install on device: `adb install -r <apk>`

> APK binary is produced on your machine (Unity + Android SDK). This repo Day 4 delivers settings, quality service, and checklist — run the build locally to generate the artifact.
